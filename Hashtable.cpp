...
void Hashtable::insert(string filename, string d, int q) // Inserts a element (+ and - value) to the Hashtable by using the insert function of Linkedlist. 
{
	table[hash(filename)].insert(filename, d, q);
}
