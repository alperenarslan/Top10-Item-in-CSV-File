...
void LinkedList::insert(string s, string d, int q) // Inserts a element (+ and - value) to the Linkedlist
{
	bool found = false;
...
{
	cout << a->fileName << a->description << "\t" << "#Total Quantity : " << a->count << endl << "------------------------------------------------------------" << endl;
}
